...
export async function getCollectionRules(params?: {
  ...
  const response = await apiClient.get(url) as ApiResponse<CollectionRule[]>
  if (!response.success) {
...
export async function getCollectionRule(ruleId: string): Promise<CollectionRule> {
  const response = await apiClient.get(`/collection-rules/${encodeURIComponent(ruleId)}`) as ApiResponse<CollectionRule>
  if (!response.success) {
    throw new Error(response.error || '获取采集规则失败')
  }
  return response.data!
...
export async function createCollectionRule(request: CreateCollectionRuleRequest): Promise<CollectionRule> {
  const response = await apiClient.post('/collection-rules', request) as ApiResponse<CollectionRule>
  if (!response.success) {
...
export async function updateCollectionRule(
  ...
  const response = await apiClient.put(`/collection-rules/${encodeURIComponent(ruleId)}`, request) as ApiResponse<CollectionRule>
  if (!response.success) {
...
export async function deleteCollectionRule(ruleId: string): Promise<void> {
  const response = await apiClient.delete(`/collection-rules/${encodeURIComponent(ruleId)}`) as ApiResponse<void>
  if (!response.success) {
...
export async function enableCollectionRule(ruleId: string): Promise<void> {
  const response = await apiClient.put(`/collection-rules/${encodeURIComponent(ruleId)}/enable`) as ApiResponse<void>
  if (!response.success) {
...
export async function disableCollectionRule(ruleId: string): Promise<void> {
  const response = await apiClient.put(`/collection-rules/${encodeURIComponent(ruleId)}/disable`) as ApiResponse<void>
  if (!response.success) {
...
export async function testCondition(request: TestConditionRequest): Promise<TestConditionResult> {
  const response = await apiClient.post('/collection-rules/test', request) as ApiResponse<TestConditionResult>
  if (!response.success) {
...
export async function getCollectionSegments(params?: {
  ...
  const response = await apiClient.get(url) as ApiResponse<CollectionSegment[]>
  if (!response.success) {
...
export async function getCollectionSegment(id: number): Promise<CollectionSegment> {
  const response = await apiClient.get(`/collection-segments/${id}`) as ApiResponse<CollectionSegment>
  if (!response.success) {
    throw new Error(response.error || '获取采集片段失败')
  }
  return response.data!
...
export async function deleteCollectionSegment(id: number): Promise<void> {
  const response = await apiClient.delete(`/collection-segments/${id}`) as ApiResponse<void>
  if (!response.success) {
